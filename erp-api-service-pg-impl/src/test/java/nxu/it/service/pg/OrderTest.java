...
public class OrderTest {
    ...
    void test_page() {
        ...
        orderPageQueryParam.setCustomerName("吴");
    ...
    void test_page_by_employee_id() {
        ...
        orderPageQueryParam.setShipperName("申通");
    ...
    void test_page_by_customer_id() {
        ...
        int customerId = 78;
        orderPageQueryParam.setShipProvince("吉林");
        orderPageQueryParam.setShipCity("通");
    ...
    void test_page_by_shipper_id() {
        OrderPageQueryParam orderPageQueryParam = new OrderPageQueryParam();
        orderPageQueryParam.setPageSize(5);
        orderPageQueryParam.setPageNumber(2);
